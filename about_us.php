...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/apple-touch-icon.jpg">
    <link rel="icon" type="image/jpg" sizes="32x32" href="statics/favicon-32x32.jpg">
    <link rel="icon" type="image/jpg" sizes="16x16" href="statics/favicon-16x16.jpg">
...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/Arghyadip.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Arghyadip Roy</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Sathyabama Institute Of Science And Technlogy,Chennai</b></p>
    </center>
