...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/apple-touch-icon.le>">
    <link rel="icon" type="image/le>" sizes="32x32" href="statics/favicon-32x32.le>">
    <link rel="icon" type="image/le>" sizes="16x16" href="statics/favicon-16x16.le>">
    ...
    <title>Welcome to ROY Bank</title>
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> ROY
                        Bank!</b></p>
            </div>
